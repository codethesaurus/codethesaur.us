...
You will receive an email from the Code Thesaurus Code of Conduct Working Group acknowledging receipt immediately. We promise to acknowledge receipt within 24 hours (and will aim for much quicker than that).
...
* A permanent or temporary ban from some or all Code Thesaurus spaces (mailing lists, IRC, etc.)
...
Finally, the Working Group will make a report on the situation to the Code Thesaurus Core Team. The board may choose to a public report of the incident.
