...
def compare(request):
    try:
        ...
        lang1_directory = lang_dir(lang1_query_string, lang1_version)
        lang2_directory = lang_dir(lang2_query_string, lang2_version)
...
def reference(request):
    try:
        ...
        lang_directory = lang_dir(lang_query_string, lang_version)
